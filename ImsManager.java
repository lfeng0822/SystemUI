...
public class ImsManager {
    ...
    public static boolean isVolteEnabledByPlatform(Context context) {
        ...
        String carrier = CarrierConfigManager.KEY_CARRIER_VOLTE_AVAILABLE_BOOL;
        boolean isResOverlaySupport = true;
        isResOverlaySupport = getIsResOverlaySupport(context, ImsConfig.FeatureConstants.FEATURE_TYPE_VOICE_OVER_LTE);
        log("volte resource value is "
            + isResOverlaySupport + ", system property is " + SystemProperties.getInt("ro.mtk_volte_support", 0)
            + ", Carrier value is " + getBooleanCarrierConfig(context,carrier));

        return (SystemProperties.getInt("ro.mtk_volte_support", 0) == 1) &&
               isResOverlaySupport &&
    ...
    public static boolean isVtEnabledByPlatform(Context context) {
        ...
        return (SystemProperties.getInt("ro.mtk_vilte_support", 0) == 1) &&
               isResOverlaySupport &&
               getBooleanCarrierConfig(context,
    ...
    public static boolean isWfcEnabledByPlatform(Context context) {
        ...
        String carrier = CarrierConfigManager.KEY_CARRIER_WFC_IMS_AVAILABLE_BOOL;
        boolean isResOverlaySupport = true;
        isResOverlaySupport = getIsResOverlaySupport(context, ImsConfig.FeatureConstants.FEATURE_TYPE_VOICE_OVER_WIFI);
        log("wfc resource value is "
            + isResOverlaySupport + ", system property is " + SystemProperties.getInt("ro.mtk_wfc_support", 0)
            + ", Carrier value is " + getBooleanCarrierConfig(context,carrier));

        return (SystemProperties.getInt("ro.mtk_wfc_support", 0) == 1) &&
               isResOverlaySupport &&
               getBooleanCarrierConfig(context,
    ...
    private boolean updateVideoCallFeatureValue() throws ImsException {
        ...
        boolean enabled = isEnhanced4gLteModeSettingEnabledByUser(mContext) &&
                isVtSettingEnabledByUser(mContext);
