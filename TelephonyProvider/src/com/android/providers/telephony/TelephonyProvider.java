...
public class TelephonyProvider extends ContentProvider
{
    ...
    // if MTK internal upgrade DB, only increase b value.
    private static final int DATABASE_VERSION = (16 << 16) + (1 << 8);
        ...
        private void copyPreservedApnsToNewTable(SQLiteDatabase db, Cursor c) {
            ...
            if (c != null) {
                ...
                while (c.moveToNext()) {
                    ...
                    if (OMACP_SUPPORT) {
                        getStringValueFromCursor(cv, c, Telephony.Carriers.OMACPID);
                        getStringValueFromCursor(cv, c, Telephony.Carriers.NAPID);
                        getStringValueFromCursor(cv, c, Telephony.Carriers.PROXYID);
                    }
                    /// @}
    ...
    public synchronized Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        switch (match) {
            ...
            case URL_TELEPHONY: {
                ...
                isApnQuery = true;
                log("query isApnQuery=" + isApnQuery);
                break;
            }
        ...
        try {
            ...
            log("isApnQuery=" + isApnQuery);
            if (isApnQuery && TelephonyProviderEx.isCdmaLteDcSupport() && (!BSP_PACKAGE)) {
