...
public class TelephonyProviderEx {
    ...
    private static final String MTK_SRLTE_PROPERTY = "ro.mtk_srlte_support";
    ...
    private static final String[] SVLTE_CARRIER_OMACP_COLUMN_NAME = {
        Telephony.Carriers._ID,
        Telephony.Carriers.NAME,
        Telephony.Carriers.NUMERIC,
        Telephony.Carriers.MCC,
     ...
     * The same as APN of 45507/45502.
     *
     * Solution: When Data framework query APN list using specified
     * numeric(46003/46011 or 45502/45507),
     * query all user defined 46003/46011, 45502/45507 APNs
     * and change APN numeric to data specified numeric,
     * then create a MatrixCursor to wrap these data.
     *
    ...
    public Cursor queryApnForSvlte(SQLiteQueryBuilder qb, SQLiteDatabase db, String[] projectionIn,
        ...
        log("queryApnForSvlte");
        if (selection != null && selectionArgs == null && projectionIn == null &&
                (selection.equals("numeric = '46011'") ||
                        selection.equals("numeric = '46003'") ||
                        selection.equals("numeric = '45502'") ||
                        selection.equals("numeric = '45507'"))) {
            String numeric;
            ...
            } else if (selection.equals("numeric = '46003'")) {
                numeric = "46003";
                selection = "((numeric = 46003 and sourcetype = 0) or " +
                        "((numeric = 46011 or numeric = 46003) and sourcetype = 1))";
            } else if (selection.equals("numeric = '45507'")) {
                numeric = "45507";
                selection = "((numeric = 45507 and sourcetype = 0) or " +
                        "((numeric = 45502 or numeric = 45507) and sourcetype = 1))";
            } else {
                numeric = "45502";
                selection = "((numeric = 45502 and sourcetype = 0) or " +
                        "((numeric = 45502 or numeric = 45507) and sourcetype = 1))";
            }
            ...
            if (cursor == null || cursor.getCount() == 0) {
                ...
                if (OMACP_SUPPORT) {
                    matrixCursor = new MatrixCursor(SVLTE_CARRIER_OMACP_COLUMN_NAME, 1);
                } else {
                    matrixCursor = new MatrixCursor(SVLTE_CARRIER_COLUMN_NAME, 1);
                }
    ...
    /**
     * Check if CDMA LTE Dual connection(SVLTE or SRLTE) support is true.
     * @return true if SVLTE or SRLTE is enabled
     */
    public static boolean isCdmaLteDcSupport() {
        boolean isCdmaLteDc = false;

        if (SystemProperties.get(MTK_SVLTE_PROPERTY).equals(SUPPORT_YES) ||
                SystemProperties.get(MTK_SRLTE_PROPERTY).equals(SUPPORT_YES)) {
            isCdmaLteDc = true;
        }

        log("isCdmaLteDcSupport = " + isCdmaLteDc);
